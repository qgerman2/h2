...
void untitled_initializer()
{
}

void untitled_terminator()
{
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3218781898U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(751438047U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1670511639U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1329037637U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(532757085U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2916222156U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2338067723U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(860112093U);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(instanceChksum, "s9Jt0OsNiIb6pSc88zrupZF") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s9Jt0OsNiIb6pSc88zrupZF") == 0) {
